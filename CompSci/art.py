...
def murica():
	canvas = america()
	canvas.create_rectangle(0,0,800,590, fill = "red")
	

class Text(object):
	def __init__(self, locationx, color = "red"):
	...
	def draw(self):
		canvas = panel.canvas
		canvas.create_text(self.locationx, 260,fill = "red", font = "Times 50 italic bold", text = "'Murica, call me <3 \n 516-493-8202")
...
def main():
	...
	stars_complete(20,15,25,7,30,15,35,15,31,20,33,27,25,24,17,27,19,20,15,15,20,15,50,39)
	panel.sleep(200)
	while 1:
		text.draw()
		panel.sleep(20)
